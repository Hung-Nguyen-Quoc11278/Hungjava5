...
import com.ps21477.entity.ReportCategory;
...
public interface ProductDAO extends JpaRepository<Product, Integer>{
	...
	@Query(value = "select top(1) Price from Products order by Price asc",nativeQuery = true)
	double getminprice();
	@Query(value = "select top(1) Price from Products order by Price desc",nativeQuery = true)
	double getmaxprice();
